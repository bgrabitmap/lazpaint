...
begin
   ...
   vsColorView := TBGRAVirtualScreen.Create(self);
   vsColorView.Caption := '';
   vsColorView.Parent := self;
...
begin
  ...
  Bitmap.Fill(FFormBackgroundColor);
